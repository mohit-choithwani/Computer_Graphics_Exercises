...
function bresenham(image, line) {
    ...
    let x_value, y_value,x_error, y_error, i;
        ...
        if (delta_abs_y > delta_abs_x)
        {
            if (delta_y< 0)
            {
                x_value = x1; y_value = y1; y_error = y0;

            }
            else
            {
                x_value = x0; y_value = y0; y_error = y1;
            }
            setPixelS(image, new Point(x_value,y_value), new Color(76,0,8), pixelScale)
            ...
            for (i = 0; y_value< y_error; i++)
            {
                ...
                setPixelS(image, new Point(x_value,y_value), new Color(55,0,8), pixelScale)
            }
        }
            ...
            if (delta_x >= 0)
            {
                x_value = x0; y_value = y0; x_error = x1;
            }
            else
            {
                x_value = x1; y_value = y1; x_error = x0;
            }
            setPixelS(image, new Point(x_value,y_value), new Color(80,0,8), pixelScale)
            ...
            for (i = 0; x_value < x_error; i++)
            {
                ...
                setPixelS(image, new Point(x_value,y_value), new Color(23,0,8), pixelScale)
            }
        }
