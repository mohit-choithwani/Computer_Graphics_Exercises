...
function webGLStart(canvas) {
    ...
    gl.vertexAttribPointer(attrVertexPosition, 2, gl.FLOAT, false,  5 * Float32Array.BYTES_PER_ELEMENT, 0);

    let attrVertexColor = gl.getAttribLocation(shaderProgram, "tricolor");
    gl.enableVertexAttribArray(attrVertexColor);
    gl.vertexAttribPointer(attrVertexColor, 3, gl.FLOAT, false,5 * Float32Array.BYTES_PER_ELEMENT,2 * Float32Array.BYTES_PER_ELEMENT);
;
